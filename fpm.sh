...
fpm --debug --no-depends -m BladeMaker -s dir -t deb -n pgsql-dumper -v $RELEASE_TAG -p bin/pgsql-dumper_amd64.deb bin/pgsql-dumper-amd64-linux=/usr/local/bin/pgsql-dumper
